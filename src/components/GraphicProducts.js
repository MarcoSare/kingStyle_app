...
export function GraphicProducts(){
    ...
    return(
      <>
        ...
        <label className='reports__titlGraphics'>NUMERO DE TOTAL DE PRODUCTOS</label>
        ...
        <label className='reports__titlGraphics'>NUMERO DE PRODUCTOS POR FILTRO</label>
